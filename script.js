...
let appData = {
    ...
    getIncome: function() {
     ...
     /*getAddIncome: function() {
        let addincams = additionalIncomeItem.value.split(',');
        //let addincams = additionalIncomeItem.value;
        addincams.forEach(function(item){
            item = item.trim();
            if (item !== '') {
                appData.addincams.push(item.value);
            }
        });
     },*/
